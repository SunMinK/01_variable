...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		booleanData = true;
		// = : 대입 연산자 ==>같다는 뜻아님. 오른쪽에 있는 값을 왼쪽에 대입하겠다.
		System.out.println("booleanData:" + booleanData);
		
		// 자료형은 byte 변수명 byteNumber 값 127 대입
		byte byteNumber = 127;
		/* 메모리에 정수값을 할당할 공간 1byte 할당하고
		...
		// 정수 자료형의 기본형! (short, byte 옜날 코드의 잔재)
		int intNumber = 21483647; // 변수 선언 및 초기화
		// 자료형 변수명 = 리터럴
		...
		// 실수형
		float floatNumber = 1.2345f; // F,f안써주면 double로 인식해서 오류
		...
		//변수 명명 규칙
		//1. 대소문자 구분 한다(대소문자 다르면 다른변수),길이제한 없다.
		//2. 예약어 사용 x
		//float double;
		...
		int $inNumber; //문제는 없지만 개발자가 직접 사용 안합니다.
